...
% WARNDLG M-file for warndlg.fig
%      WARNDLG by itself, creates a new WARNDLG or raises the
%      existing singleton*.
%
%      H = WARNDLG returns the handle to a new WARNDLG or the handle to
%      the existing singleton*.
%
%      WARNDLG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WARNDLG.M with the given input arguments.
%
%      WARNDLG('Property','Value',...) creates a new WARNDLG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before warndlg_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to warndlg_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help warndlg

% Last Modified by GUIDE v2.5 14-Nov-2012 11:34:58
